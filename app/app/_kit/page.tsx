  ...
  return (
    <Shell>
      <div className="mx-auto flex w-full max-w-[1000px] flex-col gap-10 px-4 py-10">
        <section><h2 className="text-[22px] font-extrabold">Marks</h2><div className="mt-3 flex items-end gap-6">{[16, 32, 128].map((s) => <div key={s} className="flex flex-col items-center gap-2"><Mark size={s} /><span className="mono text-[11px] text-ink-muted">{s}px</span></div>)}<Wordmark /><Wordmark live /></div></section>
        <section><h2 className="text-[22px] font-extrabold">Type</h2><p className="text-[56px] font-extrabold leading-none">Display 56</p><p className="text-[28px] font-extrabold">Heading 28</p><p className="text-[16px]">Body 16, Funnel Sans, measure 60ch. Buttons name their result.</p><p className="mono text-[14px]">Mono 14 · 04:12 · $0.0122 · tabular</p></section>
