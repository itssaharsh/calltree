...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Calltree", description: "Heat-alert check-in calls for a town's vulnerable-persons register. Lex understands, code decides, people get the unclear ones.", type: "website" },
};
